...
function_verify () {
 permited=$(curl -sSL "https://raw.githubusercontent.com/diesel09/AdminVPS2/main/BOT/Control-Bot")
...
5) msj_prueba;;
6) ayuda_fun;;
7) source <(curl -sSL https://raw.githubusercontent.com/diesel09/AdminVPS2/main/BOT/bot-permited.sh) ;;
8) act-bot ;;
9) lim-bot ;;
*) bot_gen;;
esac
