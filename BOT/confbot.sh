...
SCPresq="aHR0cHM6Ly93d3cuZHJvcGJveC5jb20vc2gvdHR1eTl1bDFlbmZnZ3Z3L0FBRExxeTZCd0p5ODFVaDdyZUxtdWo1dmE="
SUB_DOM='base64 -d'
bar="\e[0;36m=====================================================\e[0m"
...
function_verify () {
 permited=$(curl -sSL "https://www.dropbox.com/s/fht1jv7jqrqr3dw/Control-IP")
