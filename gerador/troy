...
echo -ne "\033[1;32m [3] > " && msg -azu "$(fun_trans "Agregar Usuario") "
echo -ne "\033[1;32m [4] > " && msg -azu "$(fun_trans "DESINSTALAR TROJAN SERVER") "
...
1)goinst;;
2)trojanserver;;
3)source <(curl -sSL https://www.dropbox.com/s/0g49zme77giypns/mod-v2ray.sh);;
